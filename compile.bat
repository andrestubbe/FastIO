...
set PROJECT_NAME=fastio

echo ===========================================
echo FastIO Native Builder (FastJava Standard)
echo ===========================================
...
cl.exe /LD /O2 /EHsc /Fe:release\%PROJECT_NAME%.dll src\main\native\fastio.cpp /I"!JAVA_HOME!\include" /I"!JAVA_HOME!\include\win32" /link /SUBSYSTEM:WINDOWS kernel32.lib
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo ===========================================
    echo [SUCCESS] FastIO native DLL built!
